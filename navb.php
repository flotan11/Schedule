...
public static function generateNav() {
	$menu = array(
  	'menu_teacher.php'  => array('text'=>'Schedule',  'url'=>'menu_teacher.php'),
  	'mail.php'  => array('text'=>'Mail',  'url'=>'mail.php'),
  	'createE.php' => array('text'=>'Create E', 'url'=>'createE.php'),
  	'listE.php' => array('text'=>'List E', 'url'=>'listE.php'),
	);
